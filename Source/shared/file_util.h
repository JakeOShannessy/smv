...
#define FILE_EXISTS_CASEDIR(a)                                                 \
  FileExists(a, sextras.filelist_coll.filelist_casename, sextras.filelist_coll.nfilelist_casename, \
             sextras.filelist_coll.filelist_casedir,       \
             sextras.filelist_coll.nfilelist_casedir)

...
void ReadCAD2Geom(cadgeomdata *cd, GLfloat block_shininess){
  ...
  // TODO: what does this do. Seems like if there is nothing read, delete all of the cad info
...
/// @brief Read CAD geometry data to 'cd'. 'cd' includes the file path to read from.
/// @param cd A pointer to one of the cadgeomdata entries in the cadegeominfo array

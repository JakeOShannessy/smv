...
extern "C" void GLUIDisplaySetup(int main_window){
  ...
  ROLLOUT_general1 = glui_labels->add_rollout("Labels/Titles", true, LABELS_TITLES_ROLLOUT);
  ...
  ROLLOUT_general2 = glui_labels->add_rollout("Lines/Offsets/Surfaces/Other", false, LABELS_OFFSETS_ROLLOUT);

...
EXTERNCPP cameradata *GetCamera(cameradata *camera_list_first, char *name);
EXTERNCPP char  *GetCameraLabel(cameradata *camera_list_first, int index);
EXTERNCPP void  InitCamera(cameradata *camera_data, const char *name);
EXTERNCPP void  InitCameraList(void);
EXTERNCPP cameradata *InsertCamera(cameradata *cb,cameradata *source, const char *name);

...
extern "C" void GLUIShooterSetup(int main_window){
  ...
  SPINNER_shooter_x->set_float_limits(sextras.xbar0,xbarORIG);
  ...
  SPINNER_shooter_y->set_float_limits(sextras.ybar0,ybarORIG);
  ...
  SPINNER_shooter_z->set_float_limits(sextras.zbar0,zbarORIG);
  ...
  SPINNER_shooter_dx->set_float_limits(0.0,xbarORIG-sextras.xbar0);
  ...
  SPINNER_shooter_dy->set_float_limits(0.0,ybarORIG-sextras.ybar0);
  ...
  SPINNER_shooter_dz->set_float_limits(0.0,zbarORIG-sextras.zbar0);

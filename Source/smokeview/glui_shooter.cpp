...
extern "C" void GLUIShooterSetup(int main_window){
  ...
  ROLLOUT_shooter_frame = glui_shooter->add_rollout("Starting locations/velocities", true, START_SHOOTER_ROLLOUT);
  ...
  ROLLOUT_shooter_velocity = glui_shooter->add_rollout("Background velocity field", false, BACKGROUND_SHOOTER_ROLLOUT);

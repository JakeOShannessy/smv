...
// legacy fixed pipeline If you are new to Dear ImGui, read documentation from
// the docs/ folder + read the top of imgui.cpp. Read online:
...
//     functions installed for us,
//     // otherwise it is possible to install our own functions and call the

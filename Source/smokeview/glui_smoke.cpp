...
extern "C" void GLUI3dSmokeSetup(int main_window){
  ...
  ROLLOUT_smokecolor = glui_3dsmoke->add_rollout_to_panel(ROLLOUT_smoke3d, _("Smoke color"),false, SMOKECOLOR_ROLLOUT);
  ...
  if(colorbars.ncolorbars > 0){
    ROLLOUT_firecolor = glui_3dsmoke->add_rollout_to_panel(ROLLOUT_smoke3d, _("Fire color"), false, FIRECOLOR_ROLLOUT);
